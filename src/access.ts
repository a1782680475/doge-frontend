...
export default function access(initialState: { currentUser?: API.CurrentUser | undefined }) {
  ...
  return {
    ...
    bulletin:hasAuthority('sys:bulletin'),
    bulletinAdd: hasAuthority('sys:bulletin:add'),
    bulletinEdit: hasAuthority('sys:bulletin:edit'),
    bulletinDelete: hasAuthority('sys:bulletin:delete'),
